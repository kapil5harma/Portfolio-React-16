...
const SocialIcons = (props) => {
  ...
  return (
    <div className="social-icons animate-icons">
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/kapilsharma1994/"><i className="fab fa-linkedin"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://medium.com/@kapilsharmajmps"><i className="fab fa-medium"></i></a>
      </div>
  );
};
